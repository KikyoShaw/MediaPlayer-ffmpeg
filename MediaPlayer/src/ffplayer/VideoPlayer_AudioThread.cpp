...
void ffPlayer::sdlAudioCallBackFunc(void *userdata, Uint8 *stream, int len)
{
	ffPlayer *player = (ffPlayer*)userdata;
    player->sdlAudioCallBack(stream, len);
}

void ffPlayer::sdlAudioCallBack(Uint8 *stream, int len)
{
...
int ffPlayer::decodeAudioFrame(bool isBlock)
{
