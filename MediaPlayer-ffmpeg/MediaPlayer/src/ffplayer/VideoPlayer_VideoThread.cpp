...
#if CONFIG_AVFILTER
int ffPlayer::configure_filtergraph(AVFilterGraph *graph, const char *filtergraph, AVFilterContext *source_ctx, AVFilterContext *sink_ctx)
{
    int ret, i;
...
int ffPlayer::configure_video_filters(AVFilterGraph *graph, const char *vfilters, AVFrame *frame)
{
...
void ffPlayer::decodeVideoThread()
{
